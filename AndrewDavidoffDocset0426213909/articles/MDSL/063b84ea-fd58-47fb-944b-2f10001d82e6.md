...
<body>
 ...
 <div id="header"><h1 class="heading">4.694 ResizeGrip</h1></div>
...
ResizeGrip </b>
 ...
 <td>Represents an implementation of a Thumb control that enables a Window to change its size. </td>
 </tr>
