...
<body>
 ...
 <div id="header"><h1 class="heading">4.154 DataGridCheckBoxColumn</h1></div>
...
DataGridCheckBoxColumn </b>
 ...
 <td>Represents a DataGrid column that hosts CheckBox controls in its cells. </td>
 </tr>
 ...
 <td>A value that indicates whether the hosted CheckBox controls enable three states or two. </td>
 </tr>
