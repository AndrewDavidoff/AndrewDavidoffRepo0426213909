...
<body>
 ...
 <div id="header"><h1 class="heading">6.139 MouseButtonSyntax</h1></div>
 ...
 <td>The first extended mouse button.</td>
 </tr>
 <tr><td><div class="indent2">XButton2</div></td>
 <td>The second extended mouse button.</td>
 </tr>
</table>
 </content>
 </div>
