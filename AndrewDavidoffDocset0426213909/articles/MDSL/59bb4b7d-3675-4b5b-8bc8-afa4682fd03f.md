...
<body>
 ...
 <div id="header"><h1 class="heading">4.671 RadioButton</h1></div>
...
RadioButton </b>
 ...
 <tr><td colspan="2">
<mshelp:link keywords="3274ac4f-11ed-4863-b98a-1ba9fed1788c" tabindex="0">RibbonRadioButton</mshelp:link> </td>
 </tr>
 <tr><td><div class="indent0">(usage)</div></td>
 <td>&lt;RadioButton&gt; <mshelp:link keywords="86913f34-aa06-4c94-9f09-83936a822fd8" tabindex="0">x:Object</mshelp:link> &lt;/RadioButton&gt; </td>
 </tr>
 <tr><td><div class="indent0">(description)</div></td>
 <td>Represents a button that can be selected, but not cleared, by a user. The IsChecked property of a RadioButton can be set by clicking it, but it can only be cleared programmatically. </td>
 </tr>
 ...
 <tr><td><div class="indent2">GroupName</div></td>
 <td><mshelp:link keywords="9defda5a-685e-4b5a-9b63-e97e2b4184ee" tabindex="0">x:String</mshelp:link> </td>
 </tr>
 <tr><td><div class="indent4">(description)</div></td>
 <td>The name that specifies which RadioButton controls are mutually exclusive. </td>
 </tr>
</table>
 </content>
 </div>
