...
<body>
 ...
 <div id="header"><h1 class="heading">4.794 SingleAnimationUsingKeyFrames</h1></div>
...
SingleAnimationUsingKeyFrames </b>
 ...
 <tr><td><div class="indent4">(description)</div></td>
 <td>The collection of SingleKeyFrame objects that define the animation. </td>
 </tr>
</table>
 </content>
 </div>
