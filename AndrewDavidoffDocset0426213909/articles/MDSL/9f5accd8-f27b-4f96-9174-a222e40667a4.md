...
<body>
 ...
 <div id="header"><h1 class="heading">6.245 UpdateSourceTriggerSyntax</h1></div>
 ...
 <td>The default UpdateSourceTrigger value of the binding target property. The default value for most properties is PropertyChanged, while the Text property has a default value of LostFocus.</td>
 </tr>
