...
<body>
 ...
 <div id="header"><h1 class="heading">4.836 StatusBar</h1></div>
...
StatusBar </b>
 ...
 <td>&lt;StatusBar&gt; <mshelp:link keywords="86913f34-aa06-4c94-9f09-83936a822fd8" tabindex="0">x:Object</mshelp:link>* &lt;/StatusBar&gt; </td>
 </tr>
 <tr><td><div class="indent0">(description)</div></td>
 <td>Represents a control that displays items and information in a horizontal bar in an application window. </td>
 </tr>
 ...
 <tr><td><div class="indent4">(description)</div></td>
 <td>The key that represents the style to use for Separator objects in the StatusBar. </td>
 </tr>
</table>
 </content>
 </div>
