...
<body>
 ...
 <div id="header"><h1 class="heading">6.189 RoutedEventSyntax</h1></div>
 ...
 <td>Either a string of the form namespacePrefix:TypeName.EventName, or a string of the form TypeName.PropertyName.</td>
 </tr>
