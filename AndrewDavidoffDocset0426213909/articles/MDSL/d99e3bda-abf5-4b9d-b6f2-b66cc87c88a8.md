...
<body>
 ...
 <div id="header"><h1 class="heading">4.737 RibbonSeparator</h1></div>
...
RibbonSeparator </b>
 ...
 <td>&lt;RibbonSeparator /&gt; </td>
 </tr>
 <tr><td><div class="indent0">(description)</div></td>
 <td>Represents a control that provides a divider and optional label between elements in a Ribbon menu or RibbonGallery. </td>
 </tr>
 ...
 <td>The text that is displayed with the visual separator line. </td>
 </tr>
</table>
 </content>
 </div>
